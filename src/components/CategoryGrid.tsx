      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[300px] md:auto-rows-[400px]">
        {categories.map((cat, i) => (
          <Link
            ...
            className={`relative group overflow-hidden cursor-pointer cursor-view block ${
          ...
          >
            <Reveal delay={i * 0.1}>
              ...
              <div className="absolute bottom-8 left-8">
                <span className="relative text-white text-xs tracking-[0.3em] font-bold uppercase pb-1 block">
                  Explore
